...
subset_name="FLICA_32k_st2"

# Directory containing the SNP statistics files
stats_dir="/data/clusterfs/lag/users/jitame/FLICA/geno/regenie/st2_in_gwas"

# Directory where output is written to
working_dir="/data/clusterfs/lag/users/jitame/FLICA/geno/regenie/st2_in_gwas/"
