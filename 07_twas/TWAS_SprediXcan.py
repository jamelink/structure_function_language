...
if __name__ == "__main__":
    ...
    gwas_file = '/data/workspaces/lag/workspaces/lg-ukbiobank/projects/FLICA_multimodal/evo_annots/twas/FLICA_32k_5c_c2_liftover_hg38.txt.gz'
    ...
    for model_db_path in model_db_paths:
        ...
        output_file = os.path.join('/data/workspaces/lag/workspaces/lg-ukbiobank/projects/FLICA_multimodal/evo_annots/twas/5c', os.path.basename(model_db_path).replace(".db", "_assoc.txt"))
